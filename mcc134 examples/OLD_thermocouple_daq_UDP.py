...
"""
    UPDATED BY KATE 9/11/2025 FOR UDP CONNECTION
...
class ThermocoupleApplication: 
    ...
    def _UDP_conn(s):
        ...
        # Set IP
        host, port = '192.168.1.32', 55555
        receiving_address = (host, port) 
        ...
        while True:
                ...
                sock.sendto(message, receiving_address)
		#time.sleep(0.01)
